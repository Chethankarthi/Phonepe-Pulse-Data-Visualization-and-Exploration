...
def map_user_plot_1(df, year):
    ...
    fig_map_user_plot_1= px.line(muyg, x= "States", y= ["RegisteredUser","AppOpens"], markers= True,
                                width=1000,height=800,title= f"{year} REGISTERED USER AND APPOPENS", color_discrete_sequence= px.colors.sequential.Rainbow_r)
...
if select == "Home":
    ...
    with col2:
        st.video("C:\\Users\\Admin\\Desktop\\youtube_project\\PhonePe Advertisement.mp4")

    col3,col4= st.columns(2)
    
    with col3:
        st.video("C:\\Users\\Admin\\Desktop\\youtube_project\\PhonePe Motion Graphics.mp4")
    ...
    with col6:
        st.video("C:\\Users\\Admin\\Desktop\\youtube_project\\phonepe ad2.mp4")
...
if select == "Data Exploration":
    ...
    with tab1:
        ...
        if method == "Insurance Analysis":
            ...
            df_agg_insur_Y= Aggre_insurance_Y(Aggregated_insurance,years)
            ...
            df_agg_tran_Y= Aggre_insurance_Y(Aggregated_transaction,years_at)
            ...
            year_au= st.selectbox("Select the Year_AU",Aggregated_user["Years"].unique())
